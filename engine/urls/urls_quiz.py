...
urlpatterns = [
    ...
    url(
        r"^launch_quiz_manager$", views.launch_quiz_manager, name="launch_quiz_manager"
    ),
    # collaborator-related
    url(
        r"^collaborator_request$",
        views.collaborator_request,
        name="collaborator_request",
    ),
    url(
        r"^collaborator_create$", views.collaborator_create, name="collaborator_create"
    ),
