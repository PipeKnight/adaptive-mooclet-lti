...
urlpatterns = [
    ...
    url(
        r"^question_and_answers_modify$",
        views.question_and_answers_modify,
        name="question_and_answers_modify",
    ),
    ...
    url(
        r"^get_question_data$", views.get_question_results, name="get_question_results"
    ),
    url(
        r"^calculus_comparison$", views.calculus_comparison, name="calculus_comparison"
    ),
]
