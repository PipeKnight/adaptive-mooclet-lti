...
urlpatterns = [
    ...
    url(
        r"^simulate_probabilities$",
        views.mooclet_simulate_probabilities,
        name="mooclet_simulate_probabilities",
    ),
    url(
        r"^modify_version_values$",
        views.mooclet_modify_version_values,
        name="mooclet_modify_version_values",
    ),
    ...
    url(
        r"^version/(?P<version_id>[0-9]+)/modify$",
        views.version_modify,
        name="version_modify",
    ),
    url(r"^explanation/create$", views.explanation_create, name="explanation_create"),
    url(
        r"^explanation_modify/(?P<version_id>[0-9]+)/modify$",
        views.explanation_modify,
        name="explanation_modify",
    ),
