    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "answer",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="engine.Answer"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="question name"),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="engine.Mooclet"
            ),
        ),
        migrations.AddField(
            model_name="value",
            name="variable",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="engine.Variable"
            ),
        ),
        migrations.AddField(
            model_name="policy",
        ...
        migrations.AddField(
            ...
            name="question",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="engine.Question"
            ),
        ),
        migrations.AlterOrderWithRespectTo(
            name="answer",
